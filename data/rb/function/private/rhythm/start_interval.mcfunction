...
execute if score #song_select rb matches 4 run function rb:private/boss/skill_5
execute if score #song_select rb matches 4 run function rb:private/boss/skill_6